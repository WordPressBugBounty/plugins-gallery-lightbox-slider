...
function glg_frontend_enqueue_scripts()
{
    ...
    wp_register_script( 'glg-photobox', GLG_URL.'/js/jquery/photobox/jquery.photobox.min.js', [  ], GLG_VERSION, false );
    wp_register_style( 'glg-photobox-style', GLG_URL.'/css/photobox/photobox.min.css', [  ], GLG_VERSION, false );
...
function glg_trial_notify()
{
    ...
    if ( get_option( 'glg_trial_notify' ) == '' ) {
        ...
        wp_localize_script( 'glg-popup', 'glg_popup', [ 'content' => $cnt ] );
