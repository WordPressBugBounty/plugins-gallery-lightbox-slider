...
function glg_menu_page() {
	...
	add_menu_page( 'Gallery Lightbox Settings', 'Gallery Lightbox', 'manage_options', 'gallery-lightbox-settings', 'glg_settings_page', 'dashicons-format-gallery', 20 );
}
...
function glg_settings_page() {
	...
	wp_enqueue_script( 'glg-checkbox' );
	wp_enqueue_style( 'glg-checkbox-style' );
	add_thickbox();
	...
	<div class="settings-wrap" id="page-settings" style="display:none;">
		<div id="option-tree-header-wrap">
			<ul id="option-tree-header">
				<li id="option-tree-version"><span><?php echo esc_html( GLG_ITEM_NAME ); ?></span></li>
				<li style="float:right;" id="option-tree-version"><span>v <?php echo esc_html( GLG_VERSION ); ?></span>
				</li>
			</ul>
		</div>
		<div id="option-tree-settings-api">
			<div class="ui-tabs ui-widget ui-widget-content ui-corner-all">
				<ul>
					...
					<li class="glg_tab_items" id="glg-docs"><a href="#section_documentation">Documentation</a></li>
					<li data-act="glg_free_plugins_page"
						data-nonce="<?php echo wp_create_nonce( 'glg_free_plugins_nonce' ); ?>"
						class="glg_tab_items glg_ajax_caller"><a href="#section_freeplugins">Free Install Plugins</a>
					</li>
					<li data-act="glg_pro_plugins_page"
						data-nonce="<?php echo wp_create_nonce( 'glg_pro_plugins_nonce' ); ?>"
						class="glg_tab_items glg_ajax_caller"><a href="#section_premiumplugins">Premium Plugins</a></li>
					<?php
